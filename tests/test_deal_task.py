...
class FakeRepository:
    def __init__(self):
        self.task_info_list = [TaskInfo(id=1, type_='video', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/视频/video_3.mp4'), dev=66312, ino=2693, duration_ms_flag=True, width_height_flag=True, hls_flag=True, thumb_flag=False),
                               ...
                               TaskInfo(id=11, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_9.jpg'), dev=66312, ino=2686, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
                               TaskInfo(id=12, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_1.jpg'), dev=66312, ino=2678, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
                               TaskInfo(id=13, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_10.jpg'), dev=66312, ino=2687, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
                               TaskInfo(id=14, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_3.jpg'), dev=66312, ino=2680, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
                               TaskInfo(id=15, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_6.jpg'), dev=66312, ino=2683, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
                               TaskInfo(id=16, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_4.jpg'), dev=66312, ino=2681, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
                               TaskInfo(id=17, type_='image', path=Path('/MEGA/Vscode/ProjectsWeb/MediaNest/Untitled Folder/图片/风景/img_2.jpg'), dev=66312, ino=2679, duration_ms_flag=False, width_height_flag=True, hls_flag=False, thumb_flag=True),
