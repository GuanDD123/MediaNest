...
class FakeRepository:
    ...
    def segments_select_join_node_id_by_parent_path(self, parent_path):
        return [
            VideoSegmentInfo(
                video_id=7,
                video_parent_path=Path("/7"),
                video_name="77",
                video_dev=777,
                video_ino=7777,
                segment_order=0,
                segment_duration_ms=8333,
                segment_name="seg_00000.ts",
            ),
            VideoSegmentInfo(
                video_id=1,
                video_parent_path=Path("/1"),
                video_name="11",
                video_dev=111,
                video_ino=1111,
                segment_order=0,
            ...
            VideoSegmentInfo(
                video_id=3,
                video_parent_path=Path("/3"),
                video_name="33",
                video_dev=333,
                video_ino=3333,
                segment_order=1,
                segment_duration_ms=4666,
                segment_name="seg_00001.ts",
            ),
            VideoSegmentInfo(
                video_id=1,
                video_parent_path=Path("/1"),
